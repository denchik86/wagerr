...
UniValue calculateaccumulatorvalues(const UniValue& params, bool fHelp)
{
    ...
    int nHeightTest = 210020;
    int nHeightCheckpointTest = 0;
    AccumulatorCheckpoints::Checkpoint checkpointTest = AccumulatorCheckpoints::GetClosestCheckpoint(nHeightTest, nHeightCheckpointTest);
    nHeightTest = 0;
